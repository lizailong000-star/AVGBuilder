...
CHARACTER_HINTS = {"character", "characters", "char", "chars", "sprite", "sprites", "portrait", "portraits", "avatar", "avatars", "player"}
...
def _classify_asset(file_path: Path, game_dir: Path) -> str | None:
    ...
    stem_tokens = set(stem.split("_")) | {stem}
